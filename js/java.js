document.addEventListener("DOMContentLoaded", () => {
  ...
  //modal=Modales: el contenido de la página o pantalla estará deshabilitado hasta que el usuario interactúe explícitamente con el modal
  ...
  function mostrarEvento(evento, index) {elemento 
    const li = document.createElement("li"); // Crear de lista
    li.innerHTML = `
